...
namespace DBAPP1 {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(int ID, string FNAME, string LNAME, string ADDRESS, string CITY, string TEL, string GENDER, System.DateTime DATEJOINED, int AGE) {
...
namespace DBAPP1.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([ID] = @Original_ID) AND ([FNAME] = @Original_FNAME) AND ([LNAME] = @Original_LNAME) AND ([ADDRESS] = @Original_ADDRESS) AND ([CITY] = @Original_CITY) AND ([TEL] = @Original_TEL) AND ([GENDER] = @Original_GENDER) AND ([DATEJOINED] = @Original_DATEJOINED) AND ([AGE] = @Original_AGE))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([ID], [FNAME], [LNAME], [ADDRESS], [CITY], [TEL], [GENDER], [DATEJOINED], [AGE]) VALUES (@ID, @FNAME, @LNAME, @ADDRESS, @CITY, @TEL, @GENDER, @DATEJOINED, @AGE);
SELECT ID, FNAME, LNAME, ADDRESS, CITY, TEL, GENDER, DATEJOINED, AGE FROM Employee WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [ID] = @ID, [FNAME] = @FNAME, [LNAME] = @LNAME, [ADDRESS] = @ADDRESS, [CITY] = @CITY, [TEL] = @TEL, [GENDER] = @GENDER, [DATEJOINED] = @DATEJOINED, [AGE] = @AGE WHERE (([ID] = @Original_ID) AND ([FNAME] = @Original_FNAME) AND ([LNAME] = @Original_LNAME) AND ([ADDRESS] = @Original_ADDRESS) AND ([CITY] = @Original_CITY) AND ([TEL] = @Original_TEL) AND ([GENDER] = @Original_GENDER) AND ([DATEJOINED] = @Original_DATEJOINED) AND ([AGE] = @Original_AGE));
SELECT ID, FNAME, LNAME, ADDRESS, CITY, TEL, GENDER, DATEJOINED, AGE FROM Employee WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBAPP1.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FNAME, LNAME, ADDRESS, CITY, TEL, GENDER, DATEJOINED, AGE FROM dbo.Emp" +
                "loyee";
        ...
        public virtual int Delete(int Original_ID, string Original_FNAME, string Original_LNAME, string Original_ADDRESS, string Original_CITY, string Original_TEL, string Original_GENDER, System.DateTime Original_DATEJOINED, int Original_AGE) {
        ...
        public virtual int Insert(int ID, string FNAME, string LNAME, string ADDRESS, string CITY, string TEL, string GENDER, System.DateTime DATEJOINED, int AGE) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((System.DateTime)(Original_DATEJOINED));
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_DATEJOINED, 
                    int Original_AGE) {
            return this.Update(Original_ID, FNAME, LNAME, ADDRESS, CITY, TEL, GENDER, DATEJOINED, AGE, Original_ID, Original_FNAME, Original_LNAME, Original_ADDRESS, Original_CITY, Original_TEL, Original_GENDER, Original_DATEJOINED, Original_AGE);
        }
    }
